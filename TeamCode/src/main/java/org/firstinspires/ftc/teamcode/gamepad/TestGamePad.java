    ...
    public void updateRobot() {
        ...
        if (gamepad.x) {
            if (armClawPosition == 1) {
                this.robot.intake.setArmClawPosition(ARM_CLAW_POSITION_FIRST_CONE);
            } else if (armClawPosition == 2) {
                this.robot.intake.setArmClawPosition(ARM_CLAW_POSITION_SECOND_CONE);
            } else if (armClawPosition == 3) {
                this.robot.intake.setArmClawPosition(ARM_CLAW_POSITION_THIRD_CONE);
            } else if (armClawPosition == 4) {
                this.robot.intake.setArmClawPosition(ARM_CLAW_POSITION_FOURTH_CONE);
            } else if (armClawPosition == 5) {
                this.robot.intake.setArmClawPosition(ARM_CLAW_POSITION_FIFTH_CONE);
            } else if (armClawPosition == 6) {
                this.robot.intake.setArmClawPosition(ARM_CLAW_POSITION_NEUTRAL);
            }
        }
        ...
        if (gamepad.dpad_down) {
            if (horizontalSlidePosition == 1) {
                this.robot.lift.setHorizontalSlide(HORIZONTAL_SLIDE_AUTON_POSITION_FIRST_CONE);
            } else if (horizontalSlidePosition == 2) {
                this.robot.lift.setHorizontalSlide(HORIZONTAL_SLIDE_AUTON_POSITION_SECOND_CONE);
            } else if (horizontalSlidePosition == 3) {
                this.robot.lift.setHorizontalSlide(HORIZONTAL_SLIDE_AUTON_POSITION_THIRD_CONE);
            } else if (horizontalSlidePosition == 4) {
                this.robot.lift.setHorizontalSlide(HORIZONTAL_SLIDE_AUTON_POSITION_FOURTH_CONE);
            } else if (horizontalSlidePosition == 5) {
                this.robot.lift.setHorizontalSlide(HORIZONTAL_SLIDE_AUTON_POSITION_FIFTH_CONE);
            } else if (horizontalSlidePosition == 6) {
                this.robot.lift.setHorizontalSlide(HORIZONTAL_SLIDE_NEUTRAL_POSITION);
            }
        }
        ...
        if (gamepad.dpad_left) {
            ...
            if (verticalLiftPosition == 1) {
                ...
                this.robot.lift.setVerticalLift(LOW_SCORE_VERTICAL_LIFT_POSITION);
            } else if (verticalLiftPosition == 4) {
                this.robot.lift.setVerticalLift(NEUTRAL_VERTICAL_LIFT_POSITION);
            }
        }
    }
}
